...
namespace WalkAround
{
    public static class MapBuilder
    {
        ...
        {
            { 'α', new NPC(0, 0, WalkAround.tile_size, WalkAround.tile_size*2, "Sprites/Entities/npc") },
            { 'β', new NPC(0, 0, WalkAround.tile_size, WalkAround.tile_size*2, "Sprites/Entities/npc") }
        };
